...
@protocol NMsliderDelete <NSObject>

- (void)maxHuderlvalue:(CGFloat)maxValue;
- (void)minhederlvalue:(CGFloat)minValue;

@end

@interface NMRangeSlider : UIControl

@property (nonatomic, assign) id<NMsliderDelete> delegate;

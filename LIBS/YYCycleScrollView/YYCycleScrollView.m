...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _pageControl.frame = CGRectMake(0, frame.size.height - 20, _scrollView.frame.size.width, 20);
        _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:1 green:117/255.0 blue:15/255.0 alpha:1];
        _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:225/255.0 green:225/255.0 blue:225/255.0 alpha:1];

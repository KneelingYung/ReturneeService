...
- (void)initialiseControl {
    ...
    self.sliderLine.backgroundColor = [UIColor colorWithRed:230/255.0 green:227/255.0 blue:227/255.0 alpha:1].CGColor;
    self.sliderLine.hidden = YES;
    ...
    self.sliderLineBetweenHandles.hidden = YES;
    ...
    self.leftHandle.frame = CGRectMake(0, 0, _weight, _height);
    self.rightHandle.frame = CGRectMake(0, 0, _weight, _height);
...
- (BOOL)beginTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    if (CGRectContainsPoint(CGRectInset(self.leftHandle.frame, HANDLE_TOUCH_AREA_EXPANSION, HANDLE_TOUCH_AREA_EXPANSION), gesturePressLocation) || CGRectContainsPoint(CGRectInset(self.rightHandle.frame, HANDLE_TOUCH_AREA_EXPANSION, HANDLE_TOUCH_AREA_EXPANSION), gesturePressLocation))
    {
        ...
        if (distanceFromLeftHandle < distanceFromRightHandle-50 && self.disableRange == NO){
...
-(void)setHandleImage:(UIImage *)handleImage{
    ...
    CGRect startFrame = CGRectMake(0.0, 0.0, _weight, _height);
